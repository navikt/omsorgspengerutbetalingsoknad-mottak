...
internal class ArbeidstakerutbetalingSoknadKafkaProducer(
    kafkaConfig: KafkaConfig
) : HealthCheck {
    private companion object {
        private val NAME = "ArbeidstakerutbetalingSoknadV1Producer"
    ...
    internal fun produce(
        soknad: ArbeidstakerutbetalingsSoknadOutgoing,
        metadata: Metadata
    ) {
