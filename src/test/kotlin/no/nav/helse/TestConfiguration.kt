...
object TestConfiguration {
    ...
    fun asMap(
        ...
        omsorgspengerutbetalingsoknadMottakAzureClientId: String = "omsorgspengerutbetalingsoknad-mottak",
    ) : Map<String, String>{
        ...
        if (wireMockServer != null) {
            ...
            map["nav.auth.clients.0.client_id"] = "omsorgspengerutbetalingsoknad-mottak"
